...
<meta charset="utf-8" />
        ...
        <meta name="title" content="Works | Our project" />
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="future Web , web site , reactjs , nextjs ,istanbul ,agency ,website , تصميم مواقع ، برمجة مواقع ، تصاميم ، المستقبل لتصميم المواقع ، المستقبل للبرمجيات ، المستقبل ويب ، المستقبل لتصميمات السوشيال ميديا"
        />
        <meta name="robots" content="index, follow" />
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <meta name="language" content="English" />
        <meta name="author" content="mohammed jumah" />
        <meta property="og:locale" content="en-US" />

        {/* <!-- Primary Meta Tags --> */}
        <title>Future Web</title>
        <meta name="title" content="Future Web" />
        <meta
          name="description"
          content="Future Web is website createing agency in turkey istanbul"
        />

        {/* <!-- Open Graph / Facebook --> */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.web-future.website/projects" />
        <meta property="og:title" content="Works | Our projects " />
        <meta
        ...
        <meta property="twitter:url" content="https://www.web-future.website/projects" />
        <meta
